...
# read in csv files
setwd("/Users/eve/airbnbAtKaggle")
ageSummary <- read.table('/Users/eve/airbnbAtKaggle/data/age_gender_bkts.csv', sep=',', stringsAsFactors=F, header=T)
countriesSummary <- read.table('/Users/eve/airbnbAtKaggle/data/countries.csv', sep=',', stringsAsFactors=F, header=T)
sessions <- read.table('/Users/eve/Desktop/sessions.csv', sep=',', stringsAsFactors=T, header=T)
trainUsers <- read.table('/Users/eve/airbnbAtKaggle/data/train_users_2.csv', sep=',', stringsAsFactors=T, header=T, nrows=10000)
testUsers <- read.table('/Users/eve/airbnbAtKaggle/data/test_users.csv', sep=',', stringsAsFactors=T, header=T)
F
# libraries
library(ggplot2)
library(sqldf)
